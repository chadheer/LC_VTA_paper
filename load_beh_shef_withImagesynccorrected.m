...
ip.addParameter('channels',{'Y_pos','reward','airpuff','lick', 'velocity'}); % CAN ANNOTATE might want to change the name here
...
% Handle outfile
outfile = '433_day2_beh';
numframes = [20000, 30000];
correct_frames = true;
session = struct;
tif_frame_counts = 50000;
